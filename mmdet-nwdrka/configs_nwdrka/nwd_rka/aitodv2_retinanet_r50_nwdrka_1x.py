...
data_root = '/mnt/ssd/ssdtemp/aitod_v2/' # This is the path INSIDE the Docker container

data = dict(
    train=dict(
        type='CocoDataset', # AI-TOD v2 is COCO format
    ...
    test=dict(
        type='CocoDataset',
        ann_file=data_root + 'annotations/aitodv2_val.json', # If you have test annotations
        img_prefix=data_root + 'images/aitodv2_val/'))
