...
data_root = 'data/aitod_dataset/' # This is the path INSIDE the Docker container

data = dict(
    train=dict(
        type='AITODv2Dataset', # AI-TOD v2 is COCO format
    ...
    test=dict(
        type='AITODv2Dataset',
        ann_file=data_root + 'annotations/aitod_val.json', # If you have test annotations
        img_prefix=data_root + 'images/val/'))
